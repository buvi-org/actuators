...
by_id['G05']['name']='Internal ring gear / stator radial locator'
by_id['G05']['status']='Choice C provisional packaging'
by_id['G05']['specifications'].update({'Housing joint':'Eight M2.5 x 6 source screws on 54 mm PCD; ring mounting face z 13.25 mm', 'Ring body':'OD 59.96 mm; toothed band z 5.75 to 10.75 mm, front mounting rim to z 13.25 mm. Long sleeve and stator shoulder removed.', 'Nominal screw penetration':'3.3 mm; approximately 1.73 mm outer edge material beyond M2.5 major diameter, strength unverified', 'Radial stator location':'Ring OD to 60 mm stator bore; 0.020 mm radial bond gap; overlap z 5.75 to 11.436 mm', 'Separate axial stop':'Main housing annular shoulder at z 11.436 mm; radii 30.1 to 33.5 mm'})
by_id['EM01']['specifications'].update({'Choice C profile':'OD 80 / bore 60 / slot-root diameter 68 mm; radial back iron 4 mm; 6 mm radial tooth region including tip', 'Mounting in current study':'Ring OD 59.96 mm provides radial location; main housing shoulder provides axial stop', 'Axial location':'68 sheets; gross 13.872 mm; shifted forward 4.5 mm to z -2.436 through 11.436 mm', 'Retention':'Proposed retaining bond to ring over 5.686 mm axial overlap; bond capacity and stack retention unresolved'})
by_id['EM02']['specifications']['Choice C envelope']='Radial 34.5 to 39 mm; axial -3.3 to 12.3 mm; shorter radial bundles are illustrative, not a verified winding fit'
by_id['F01']['specifications'].update({'Front joint, 8 screws':'NAUO7 and NAUO22-28: M01 main housing to compact G05 ring rim, 54 mm PCD', 'Rear joint, 16 screws':'Remaining F01 instances: M02 rear housing to M01 main housing'})
