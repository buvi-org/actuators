...
- A fixed ring gear with an integral eight-bolt mounting flange and bonded stator sleeve/shoulder. **Stator mount** exposes the joint; see [mounting design and checks](docs/STATOR-MOUNT.md).
