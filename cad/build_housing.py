...
# The seat stays at the manufacturer/Choice C position: moving it 4.5 mm rearward broke
# the eight front screws' clamp on the ring and separated the ring flange from its teeth.
# The study-invented rotor shell moves instead.
SHIFT=0.0
SEAT_Z=11.436+SHIFT
